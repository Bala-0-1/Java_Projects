...
public class ServerTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            ClientHandler mtch = new ClientHandler(s, "client " + i, reader, writer);
...
class ClientHandler implements Runnable {
    ...
    // constructor
    public ClientHandler(Socket s, String name, DataInputStream reader, DataOutputStream writer) {
        this.reader = reader;
        this.writer = writer;
        this.name = name;
        this.s = s;
            ...
            try {
                ...
                for (ClientHandler mc : ServerTest.ar) {
                    ...
                    if (mc.name.equals(recipient) && mc.isloggedin) {
                        mc.writer.writeUTF(this.name + " : " + MsgToSend);
                        break;
                    }
                }
            } catch (IOException e) {
